...
async def generate_enhancement_suggestions(original_resume: Dict[str, Any], enhanced_resume: Dict[str, Any]) -> List[Dict[str, str]]:
    ...
    try:
        ...
        prompt = f"""You are a resume enhancement expert. Compare the original and enhanced resume below and generate exactly 3 helpful enhancement suggestions.
...
Based on this comparison, generate 3 practical enhancement suggestions that:

1. **Show what was improved**: Highlight specific improvements made during enhancement
2. **Suggest further enhancements**: Provide actionable suggestions for additional improvements
3. **Focus on impact**: Help the user understand how to make their resume even more powerful

Generate suggestions like:
- "Your project descriptions were enhanced to include specific technologies. Consider adding metrics like 'improved performance by X%' to show quantifiable impact."
- "Your work experience now uses stronger action verbs. You could further enhance by adding team size you managed (e.g., 'Led team of 5 developers')."
- "Your skills section was organized better. Consider adding proficiency levels (Beginner/Intermediate/Expert) to each skill."

Return in this JSON format:
{{
    "enhancement_suggestions": [
        {{
            "suggestion": "Specific enhancement suggestion with examples",
            "category": "Projects/Experience/Skills/Summary",
            "improvement_made": "What was already improved in this area",
            "further_action": "What the user can do to enhance it more"
        }},
        {{
            "suggestion": "Another specific enhancement suggestion",
            "category": "Projects/Experience/Skills/Summary", 
            "improvement_made": "What was already improved in this area",
            "further_action": "What the user can do to enhance it more"
        }},
        {{
            "suggestion": "Third specific enhancement suggestion",
            "category": "Projects/Experience/Skills/Summary",
            "improvement_made": "What was already improved in this area", 
            "further_action": "What the user can do to enhance it more"
        }}
...
IMPORTANT: 
- Compare the before and after to show what improvements were made
- Suggest concrete, actionable next steps
- Focus on making the resume more impactful and ATS-friendly
