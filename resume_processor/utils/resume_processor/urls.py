...
urlpatterns = [
    ...
    path('resumes/suggestion-questions/<str:resume_id>/', views.SuggestionQuestionsView.as_view(), name='suggestion_questions_get'),
    path('resumes/suggestion-questions/', views.SuggestionQuestionsView.as_view(), name='suggestion_questions_post'),
]