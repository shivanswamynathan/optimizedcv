...
def clean_json_response(response_text: str) -> str:
    ...
    try:
        ...
        # If that fails, try to find content that looks like a full JSON object
        ...
        # If we still can't find anything, log the full response for debugging
...
async def analyze_resume(
    ...
    try:
        ...
        llm_logger.log_interaction(
            model_name=model_type if 'model_type' in locals() else "unknown",
...
async def deep_analysis(
    ...
    try:
        ...
        # Create new structure without suggestions
...
async def brief_analysis(
    ...
    try:
        ...
        # Create new structure without analysis
